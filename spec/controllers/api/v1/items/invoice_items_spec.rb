...
RSpec.describe Api::V1::Items::InvoiceItemsController, type: :controller do
  ...
  describe "GET #index" do
    it "returns the invoice_items belonging to a item" do
      ...
      invoice_item3 = InvoiceItem.create(item_id: item2.id, invoice_id: invoice2.id, quantity: 2, unit_price: 30.00)

      get :index, id: item2.id, format: :json
